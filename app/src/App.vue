<template>
  <div class="container">
    <light-state :light_state="light_state" @lumos-click="setLightState" />
    <div class="row">
      <light-mode :light_mode="light_mode" @light_mode-click="setLightMode" />
      <light-actions :light_rgb="light_rgb" :light_mode="light_mode" :light_speed="light_speed" :light_power="light_power"
        @light_rgb-click="setLightRgb" @light_speed-click="setLightSpeed" @light_power-click="setLightPower" />
    </div>
  </div>
</template>
...
import LightState from "./components/LightState.vue"
import LightMode from "./components/LightMode.vue"
import LightActions from "./components/LightActions.vue"
